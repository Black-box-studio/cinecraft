...
import 'package:cinecraft/presentation/widgets/skill_card.dart';
import 'package:cinecraft/presentation/widgets/skill_level.dart';
...
class _SkillsSectionState extends State<SkillsSection>
                ...
                child: Column(
                  children: [
                    ContentArea(
                      ...
                      child: _buildCinecraftSm(width: contentAreaWidthSm),
                    ),
                    SpaceH40(),
                    ContentArea(
                      width: contentAreaWidthSm,
                ...
                child: Row(
                  children: [
                    ContentArea(
                      ...
                      child: _buildCinecraftLg(width: contentAreaWidthLg),
                    ),
                    ContentArea(
                      width: contentAreaWidthLg,
  ...
  Widget _buildCinecraftLg({required double width}) {
    return Container(
      child: Row(
        children: [
          Expanded(
  ...
  Widget _buildCinecraftSm({required double width}) {
    return CinecraftInfoSection1(
      sectionTitle: StringConst.MY_SKILLS,
      title1: StringConst.SKILLS_TITLE_1,
      title2: StringConst.SKILLS_TITLE_2,
      body: StringConst.SKILLS_DESC,
