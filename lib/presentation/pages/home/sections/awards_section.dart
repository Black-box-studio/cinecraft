...
import 'package:cinecraft/presentation/widgets/bullet_text.dart';
                  ...
                  ResponsiveBuilder(
                    builder: (context, sizingInformation) {
                      ...
                      if (screenWidth < (RefinedBreakpoints().tabletSmall)) {
                        return _buildCinecraftInfoSectionSm();
                      } else {
                        return _buildCinecraftInfoSectionLg();
                      }
                    },
                  ),
                  SpaceH50(),
