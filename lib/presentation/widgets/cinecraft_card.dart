...
class CinecraftCard extends StatefulWidget {
  CinecraftCard({
    this.leading,
    this.title,
    this.subtitle,
  ...
  @override
  _CinecraftCardState createState() => _CinecraftCardState();
}

class _CinecraftCardState extends State<CinecraftCard>
