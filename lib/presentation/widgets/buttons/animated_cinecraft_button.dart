...
class AnimatedCinecraftButton extends StatefulWidget {
  final String title;
  ...
  @override
  _AnimatedCinecraftButtonState createState() =>
      _AnimatedCinecraftButtonState();
}

class _AnimatedCinecraftButtonState extends State<AnimatedCinecraftButton> {
